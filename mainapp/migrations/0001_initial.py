    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datecreated', models.DateField(auto_now_add=True)),
                ('user', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='author', to='mainapp.profile')),
            ],
        ),
        migrations.CreateModel(
            name='Revieww',
            fields=[
                ...
                ('projects', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.projects')),
